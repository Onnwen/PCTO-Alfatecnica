        ...
        if ($check){
            ...
            $mailer->Body = '<!DOCTYPE html>
                            ...
                            <div class="content">
                                ...
                                <center>
                                    <a class="center" href="https://thecouriernv.tplinkdns.com/PCTO-Alfatecnica-Stanging/pages/resetPassword.php?stringpasswordretriever='.$stringToInsert.'" target="_blank">Cambia password</a>
                                </center>
                            </div>
