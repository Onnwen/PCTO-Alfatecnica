...
<div class="content">
    ...
    <center>
        <a class="center" href="https://thecouriernv.tplinkdns.com/PCTO-Alfatecnica-PrivateLogin/pages/resetPassword.php?stringpasswordretriver=<?php echo '. $check["stringVerify"] .'" ?? "https://thecouriernv.tplinkdns.com/PCTO-Alfatecnica-Staging/index.php" ?>" target="_blank">Cambia password</a>
    </center>
</div>
...
?>"https://thecouriernv.tplinkdns.com/PCTO-Alfatecnica-PrivateLogin/pages/resetPassword.php?stringpasswordretriver=' . $check["stringVerify"] .'"