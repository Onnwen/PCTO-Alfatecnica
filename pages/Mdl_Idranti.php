                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr style="text-align: center;">
                                ...
                                <th scope="col">Numero Aziendale</th>
                                <th scope="col">Diam. Ug. Lancia mm</th>
                                <th scope="col">Pressione statica bar</th>
                                <th scope="col">Pressione dinamica bar</th>
                                <th scope="col">Collaudo</th>
                                <th scope="col">Esercizio</th>
                                <th scope="col">Dislocazione</th>
                                <th scope="col">Tipo di manutenzione</th>
