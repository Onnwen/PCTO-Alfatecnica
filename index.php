...
if (isset($_SESSION['session_id'])) {
                            ...
                            <form role="form" action="javascript:0;" method="post" id="login-form" autocomplete="on">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="emailInput" class="form-control"
                                           placeholder="Inserire mail">
                                </div>
                                <div class="form-group">
                                    <label for="passwordInput" class="sr-only">Password</label>
                                    <input type="password" name="key" id="passwordInput" class="form-control"
                                           placeholder="Inserire password">
                                </div>
                            </form>
                            <div class="d-flex justify-content-center">
                                <button type="button" id="signIn" class="btn btn-success m-lg-1">Log in</button>
                                <button type="button" id="signUp" class="btn btn-outline-success m-lg-1"
                                        data-bs-toggle="modal" data-bs-target="#registrationModal">Registrati
                                </button>
                            </div>
                            <div class="d-flex justify-content-center">
                                <a href="javascript:retrievePassword();" class="forget " data-bs-toggle="modal"
                                   data-bs-target="#retrievePassword" data-bs-whatever="forgotPassword">Forgot your
                                    password?</a>
                            </div>
                        </div>
                    </div> <!-- /.col-xs-12 -->
    ...
    <div class="modal fade" id="retrievePassword" tabindex="-1" aria-labelledby="retrievePasswordLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <label id="emailRetrievePassword" for="recovery-email" class="sr-only">Inserisci il tuo
                            account</label>
                        <input type="email" name="recovery-email" id="recovery-email" class="form-control"
                               autocomplete="off" placeholder="Inserisci la mail di accesso">
                    </form>
                </div>
                ...
                <div class="modal-body">
                    <form role="form" action="javascript:0;" method="post" id="registration-form" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="key" id="keyRegistration" class="form-control"
                                   placeholder="Inserire la password">
                        </div>
                        <div class="form-group">
                            <label id="companyCodeLabel" for="companyCode" class="sr-only">Codice azienda</label>
                            <input type="number" name="code" id="companyCode" class="form-control"
    ...
    <div class="modal fade" id="justRegistered" tabindex="-1" aria-labelledby="registeredLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="color: darkgreen" id="registeredLabel">Operazione eseguita con
                        successo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
        ...
        $('#registrationButton').on('click', function () {
            ...
            if (allFilled) {
                ...
                $.post('php/login/registration.php', {
                    ...
                    companyCode: companyCode.val().toString()
                })
                    .done(function (resp) {
